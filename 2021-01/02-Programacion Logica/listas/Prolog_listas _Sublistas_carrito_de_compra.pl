...
%Propuestos. Tarea para la casa

%Ejercicio 6: Calcular el total a pagar del carrito de compras 2.0

%Ejercicio 7: ¿Cómo contabilizar y calcular el total del carrito de manera eficiente?

%Ejercicio 8: Agregar productos al carrito 2.0 sin duplicados, actualizando la variable Cantidad

%Ejercicio 9: Agregar productos al carrito 3.0, que crea sublistas on-demand. Esto es, crea sublistas para cada tipo de producto en la medida que sea necesario.
