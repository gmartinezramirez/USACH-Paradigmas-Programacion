...
;;De forma alternativa pueden utilizar los recursos del lenguaje, filter es una funcion interna de scheme
;; NO OBSTANTE, SI LE PIDEN NO OCUPAR FUNCIONES INTERNAS, DEBE IMPLEMENTAR MI-FILTRO

;(filter (es-el-mismo-estado-de-devolucion? #f) lista-prestamo-ejemplo-con-nuevo-prestamo)